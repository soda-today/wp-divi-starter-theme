...
class SODADIVISHORT_Customize {
   ...
   public static function register ( $wp_customize ) {
      ...
      $wp_customize->add_setting( 'content_width', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
         array(
            'default'    => 1080, //Default setting/value to save
   ...
   public static function live_preview() {
    ...
    public function on_option_updated( $old_value, $new_value, $option ) {
      ...
      if(function_exists('et_update_option') && !empty($new_value['content_width'])) {
         $divi_builder_option = et_update_option('content_width', $new_value['content_width']);
      }
    }
}
